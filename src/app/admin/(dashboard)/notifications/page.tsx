      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-6 bg-card border border-border/40 rounded-3xl relative overflow-hidden transition-all duration-300">
        ...
        <div className="flex items-center gap-2 z-10">
           <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-secondary text-secondary-foreground hover:bg-secondary/95 border border-secondary rounded-xl text-xs font-semibold uppercase tracking-wider transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <CheckCheck className="w-4 h-4 text-secondary-foreground" />
            Mark All Read
          </button>
          <button
            onClick={() => setShowSettings(!showSettings)}
            className="p-2.5 bg-card border border-border hover:bg-secondary/15 rounded-xl text-muted-foreground hover:text-foreground cursor-pointer transition-colors"
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between p-4 bg-card border border-border/40 rounded-2xl text-xs">
                  <button
                    ...
                    disabled={page === 1}
                    className="px-3 py-1.5 bg-transparent hover:bg-secondary/15 text-foreground border border-border rounded-lg disabled:opacity-50 cursor-pointer"
                  >
                    Previous
                  </button>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-border/40 pb-4">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-xs bg-transparent hover:bg-secondary/15 text-foreground border border-border rounded-lg cursor-pointer"
                >
                  Close
                </button>
              </div>
