    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground font-light">Loading configurations...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-6 bg-card border border-border/40 rounded-3xl">
        <div className="space-y-1">
          <h1 className="font-serif text-2xl font-normal text-foreground">Announcements</h1>
      ...
      <form onSubmit={handleSaveSettings} className="bg-card border border-border/40 rounded-3xl p-6 space-y-6">
        <div className="flex items-center gap-2 border-b border-border/20 pb-3">
          ...
          <h2 className="font-serif text-lg font-medium">Global Bar Configuration</h2>
        </div>
          ...
          <div className="bg-card border border-border/40 rounded-3xl w-full max-w-xl shadow-2xl relative max-h-[90vh] overflow-y-auto p-6 space-y-6 my-auto">
            ...
            <form onSubmit={handleSave} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <input
                        ...
                        onChange={(e) => setCurrentAnn({ ...currentAnn, backgroundColor: e.target.value })}
                        placeholder="#000000"
                        className="flex-1 px-3 py-1.5 bg-secondary/30 border border-border focus:border-primary focus:ring-1 focus:ring-primary rounded-xl text-xs outline-none text-foreground"
                      />
                    </div>
                  </div>
              ...
              <div className="space-y-1.5 pt-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <span className="text-[9px] text-muted-foreground">Start Display Date</span>
                    <input
                      type="datetime-local"
                  ...
                  <div className="space-y-1">
                    <span className="text-[9px] text-muted-foreground">End Display Date</span>
                    <input
                      type="datetime-local"
              ...
              <div className="flex items-center gap-2.5 pt-2">
                <input
                  ...
                  className="w-4 h-4 text-primary border-border focus:ring-primary rounded-xs cursor-pointer bg-transparent"
                />
                <label htmlFor="isActiveAnn" className="text-xs text-muted-foreground select-none cursor-pointer">
                  Activate Announcement on Storefront
                </label>
              </div>
