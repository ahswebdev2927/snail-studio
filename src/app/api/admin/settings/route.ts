...
export async function POST(req: NextRequest) {
  try {
    ...
    } else if (bodyKeys.some(k => ["store_name", "store_slug", "store_email", "store_phone", "store_address", "registered_business_name", "legal_physical_address", "shipping_standard_fee", "shipping_free_threshold", "shipping_express_fee", "security_verification_timeout_minutes"].includes(k))) {
