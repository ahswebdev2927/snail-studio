...
const TEMPLATE_PRESETS: Record<string, { subject: string; html: string }> = {
  promotion: {
    ...
    html: `<html>
  <body style="font-family: 'Outfit', sans-serif; background-color: #FEFFF6; padding: 30px; margin: 0; color: #222222;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border-radius: 20px; overflow: hidden; border: 1px solid #E7DDD7;">
      <div style="background-color: #A95423; padding: 40px 20px; text-align: center;">
      ...
      <div style="padding: 40px 30px;">
        ...
        <p style="text-align: center; margin: 40px 0;">
          <a href="{{unsubscribe_url}}" style="background-color: #A95423; color: #ffffff; padding: 14px 35px; border-radius: 30px; text-decoration: none; font-weight: bold; font-size: 15px; display: inline-block; box-shadow: 0 5px 15px rgba(169,84,35,0.2);">Shop the Collection</a>
        </p>
        <p style="font-size: 16px; line-height: 1.6; border-top: 1px solid #E7DDD7; padding-top: 25px; margin-top: 30px;">We know you love shopping in <strong>{{favorite_category}}</strong>!</p>
        <p style="font-size: 15px; color: #666666; margin-bottom: 0;">Best regards,<br/>Snail Studios</p>
      </div>
      <div style="background-color: #FEFFF6; padding: 20px; text-align: center; font-size: 12px; color: #666666; border-top: 1px solid #E7DDD7;">
        You are receiving this email because you opted in to receive promotions from Snail Studios. <br/>
        <a href="{{unsubscribe_url}}" style="color: #A95423; text-decoration: underline; margin-top: 8px; display: inline-block;">Unsubscribe</a>
      </div>
    </div>
  </body>
</html>`
  ...
  <body style="font-family: 'Outfit', sans-serif; background-color: #FEFFF6; padding: 30px; margin: 0; color: #222222;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border-radius: 20px; overflow: hidden; border: 1px solid #E7DDD7;">
      <div style="background: linear-gradient(135deg, #222222 0%, #666666 100%); padding: 50px 20px; text-align: center;">
        <span style="color: #A95423; text-transform: uppercase; font-size: 12px; letter-spacing: 3px; font-weight: bold; display: block; margin-bottom: 10px;">New Arrival Release</span>
      ...
      <div style="padding: 40px 30px;">
        ...
        <h3 style="color: #A95423; font-family: Georgia, serif; border-bottom: 1px solid #E7DDD7; padding-bottom: 8px; margin-top: 30px;">Featured Collection Sets</h3>
        <div style="margin: 25px 0; text-align: center;">
          {{recommended_products}}
        </div>
        
        <p style="text-align: center; margin: 40px 0 20px 0;">
          <a href="{{unsubscribe_url}}" style="background-color: #222222; color: #ffffff; padding: 14px 35px; border-radius: 30px; text-decoration: none; font-weight: bold; font-size: 15px; display: inline-block;">Explore the Collection</a>
        </p>
      </div>
      <div style="background-color: #FEFFF6; padding: 20px; text-align: center; font-size: 12px; color: #666666; border-top: 1px solid #E7DDD7;">
  ...
  <body style="font-family: 'Outfit', sans-serif; background-color: #FEFFF6; padding: 30px; margin: 0; color: #222222;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border-radius: 20px; overflow: hidden; border: 1px solid #E7DDD7;">
      <div style="background-color: #EFD3C9; padding: 40px 20px; text-align: center; border-bottom: 1px solid #E7DDD7;">
        <h1 style="color: #A95423; font-family: 'Georgia', serif; margin: 0; font-size: 26px; font-weight: normal;">Your Saved Styles Await</h1>
      </div>
      <div style="padding: 40px 30px;">
        <p style="font-size: 16px; line-height: 1.6; margin-top: 0;">Hi {{customer_name}},</p>
        ...
        <h3 style="color: #A95423; font-family: Georgia, serif; border-bottom: 1px solid #E7DDD7; padding-bottom: 8px; margin-top: 30px;">Saved Items in Your Wishlist</h3>
        ...
        <p style="text-align: center; margin: 35px 0;">
          <a href="{{unsubscribe_url}}" style="background-color: #A95423; color: #ffffff; padding: 14px 35px; border-radius: 30px; text-decoration: none; font-weight: bold; font-size: 15px; display: inline-block;">Return & Order Now</a>
        </p>
      </div>
      <div style="background-color: #FEFFF6; padding: 20px; text-align: center; font-size: 12px; color: #666666; border-top: 1px solid #E7DDD7;">
        Snail Studios &bull; Premium Reusable Press-On Nails<br/>
  ...
  <body style="font-family: 'Outfit', sans-serif; background-color: #FEFFF6; padding: 30px; margin: 0; color: #222222;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border-radius: 20px; overflow: hidden; border: 1px solid #E7DDD7;">
      <div style="background-color: #EFD3C9; padding: 40px 20px; text-align: center; border-bottom: 1px solid #E7DDD7;">
        <h1 style="color: #A95423; font-family: 'Georgia', serif; margin: 0; font-size: 26px; font-weight: normal;">Don't Leave Your Nails Behind</h1>
      </div>
      <div style="padding: 40px 30px;">
        <p style="font-size: 16px; line-height: 1.6; margin-top: 0;">Hi {{customer_name}},</p>
        ...
        <h3 style="color: #A95423; font-family: Georgia, serif; border-bottom: 1px solid #E7DDD7; padding-bottom: 8px; margin-top: 30px;">Items in Your Cart</h3>
        <div style="margin: 25px 0;">
          {{cart_products}}
        </div>
        
        <div style="border: 2px dashed #A95423; background-color: #EFD3C9; padding: 25px; border-radius: 15px; text-align: center; margin: 30px 0;">
          <p style="margin: 0; font-size: 14px; color: #666666;">Apply checkout coupon code:</p>
          <h2 style="font-family: monospace; font-size: 26px; margin: 10px 0; letter-spacing: 3px; color: #222222;">{{coupon_code}}</h2>
          <p style="margin: 0; font-size: 11px; color: #666666;">Save 10% on your shopping cart order today!</p>
        </div>
        
        <p style="text-align: center; margin: 35px 0;">
          <a href="{{unsubscribe_url}}" style="background-color: #A95423; color: #ffffff; padding: 14px 35px; border-radius: 30px; text-decoration: none; font-weight: bold; font-size: 15px; display: inline-block;">Complete Checkout</a>
        </p>
      </div>
      <div style="background-color: #FEFFF6; padding: 20px; text-align: center; font-size: 12px; color: #666666; border-top: 1px solid #E7DDD7;">
        Snail Studios &bull; Premium Reusable Press-On Nails<br/>
    ...
    mockHtml = mockHtml.replaceAll("{{cart_products}}", cartMock);
     ...
     const productsMock = selectedProductIds.length > 0 
      ? products
          ...
          .map((p) => `
            <div style="display: inline-block; width: 120px; margin: 10px; text-align: center; border: 1px solid #E7DDD7; padding: 10px; border-radius: 8px;">
              ...
              <span style="font-size: 11px; color: #A95423; font-weight: bold;">₹1,500</span>
            </div>
          `).join("")
      : `
        <div style="display: inline-block; width: 120px; margin: 10px; text-align: center; border: 1px solid #E7DDD7; padding: 10px; border-radius: 8px;">
          <p style="margin: 5px 0 0 0; font-size: 12px; font-weight: bold; color: #000000;">Classic French</p>
          <span style="font-size: 11px; color: #A95423; font-weight: bold;">₹1,200</span>
        </div>
        <div style="display: inline-block; width: 120px; margin: 10px; text-align: center; border: 1px solid #E7DDD7; padding: 10px; border-radius: 8px;">
          <p style="margin: 5px 0 0 0; font-size: 12px; font-weight: bold; color: #000000;">Cat-Eye Aura</p>
          <span style="font-size: 11px; color: #A95423; font-weight: bold;">₹1,600</span>
        </div>
      `;
